...
parser.add_argument('--no_clients', default=10, help="number of clients, 'mnist' and 'fashion-mnist': 10, 'cifar10': 30")
...
parser.add_argument('--bw', type=float, default=1, help="bandwidth of KDE, 'mnist' and 'fashion-mnist': 1, 'cifar10': 0.1")
